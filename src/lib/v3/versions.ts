...
export const CONSTRUCTOR_VERSIONS: ConstructorVersion[] = [
  ...
  },
  {
    ...
    title: "AI-конструктор V3.1 · единый дом и участок",
    route: "/constructor-ai-v3-1",
    status: "experiment",
    description:
      "Развитие V3: магнитная стыковка секций в один дом, монохромный план с автоматической меблировкой, синхронный белый 3D и посадка на участок на том же экране.",
    createdAt: "2026-08-10",
  },
];
