 ...
 *
 * В правой колонке конструктора их больше нет — там реальные проекты. Здесь
 * они держатся как запасные формы: «Каскад» и «Двухэтажный» показывают
 * приёмы, которых нет ни в одном из семи каталожных домов, — консоли и второй
 * этаж. Пригодятся, когда такие проекты появятся в каталоге.
 */
