        ...
        <Container>
          <div className="mb-8 max-w-3xl">
            ...
            <p className="mt-4 text-muted-foreground">
              ...
              консолями: модули смещаются друг относительно друга с шагом 1 м. Разместите их на
              участке в масштабе, покрутите дом в 3D, примерьте дизайн фасада — площадь и стоимость
