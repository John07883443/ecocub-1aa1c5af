        ...
        <Container>
          <div className="mb-8 max-w-3xl">
            ...
            <p className="mt-4 text-muted-foreground">
              ...
              покажут, куда можно передвинуть, а модуль сам встанет на сетку с шагом 1 м. Покрутите
              дом в 3D, примерьте дизайн фасада — площадь и стоимость считаются автоматически.
            </p>
          </div>
