        ...
        <Container>
          <div className="mb-8 max-w-3xl">
            ...
            <p className="mt-4 text-muted-foreground">
              ...
              формы — одноэтажные, двухэтажные, Г- и П-образные. Разместите модули на участке в
              масштабе, покрутите дом в 3D, примерьте дизайн фасада — площадь и стоимость считаются
              автоматически.
            </p>
          </div>
